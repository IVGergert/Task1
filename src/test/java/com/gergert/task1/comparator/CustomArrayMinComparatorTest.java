...
class CustomArrayMinComparatorTest {

    CustomArrayMinComparator customArrayMinComparator = new CustomArrayMinComparator();
    ...
    void compareNormalArrays() {
        ...
        assertTrue(customArrayMinComparator.compare(arr1, arr2) < 0);
        assertTrue(customArrayMinComparator.compare(arr2, arr1) > 0);
    }
    ...
    void compareEqualsIdArrays() {
        ...
        assertEquals(0, customArrayMinComparator.compare(arr1, arr2));
    }
}